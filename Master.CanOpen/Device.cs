...
using OneDriver.Master.CanOpen.Products;
using OneDriver.Master.CanOpen;
using OneDriver.Master.CanOpen.Channels;
...
namespace OneDriver.Master.CanOpen
{
    ...
    {
        private ICanOpenMaster DeviceHAL { get; set; }
        public Device(string name, IValidator validator, ICanOpenMaster deviceHAL, IDeviceDescriptor parameterDatabank) :
